...
export const SHOP_SOURCES: Record<ShopSlug, ShopSource> = {
  ...
  jimioptical: {
    ...
    customerBlockedCategoryPatterns: [
      /our website/i,
      /daily catalog updates/i,
      /product testing/i,
    ],
    customerBlockedAlbumPatterns: [
      /^website$/i,
      ...
      /how to buy/i,
      /daily catalog updates/i,
      /identify authentic/i,
      /x-ray test/i,
      /uv protection test/i,
      /anti-blue light test/i,
      /^lead test$/i,
      /screwdriver/i,
      /polishing stick/i,
      /want more tests/i,
  ...
  hlinjewelry: {
    ...
    customerBlockedCategoryPatterns: [/contact me/i],
    customerBlockedAlbumPatterns: [
      /^click here$/i,
      /^look$/i,
      /^right$/i,
